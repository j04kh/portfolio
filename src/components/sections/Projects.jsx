  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center py-5 lg:px-12 lg:grid lg:grid-cols-2 lg:place-items-center">
        <Project
          name="Coffeeshop"
          description="E-commerce built with Next and ChakraUI"
        ...
        <Project
          name="AvWeather"
          description="Aeronautical Weather App built with React and Tailwind"
        ...
        <Project
          ...
          description="3D page built with R3F and Tailwind"
